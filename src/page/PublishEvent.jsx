      ...
      <header className="border-b border-white/10 bg-black/20 backdrop-blur-sm sticky top-0 z-[100]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">LET'S PARTY</h1>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              ...
              {/* Menú desplegable - Z-INDEX MÁXIMO */}
              {isUserMenuOpen && (
        ...
        <div className="max-w-2xl mx-auto bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg shadow-2xl">
          ...
          <div className="p-4 sm:p-6 border-b border-white/10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">Crear Evento</h2>
            </div>
            <p className="text-white/70 text-sm sm:text-base">Completa los detalles para crear tu evento increíble</p>
          </div>
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleEvent}>
              ...
              {success && (
                <div className="flex items-center gap-2 p-3 sm:p-4 rounded-lg border border-green-500 bg-green-500/10">
                  ...
                  <p className="text-green-500 font-semibold text-sm sm:text-base">Evento creado correctamente</p>
                </div>
              )}
